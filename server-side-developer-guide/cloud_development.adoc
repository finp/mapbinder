...
This file is invoked when your application is deployed to _an MBaaS_ - our cloud execution environment. In most cases
you will not need to touch this file - it is set to handle `fh.cloud()` requests from the client and route them
accordingly.
