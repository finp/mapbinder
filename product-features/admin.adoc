...
[[windows-phone-8-binaries]]
===== Windows Phone 8 Binaries

The Windows Phone 8 binaries uploaded here should be signed with a company certificate. If you want to distribute the AET file along with the binary, you can upload it as the configuration file for the binary. For more details, check out link:{MobileDeveloperGuide}#deploying-an-app-on-windows-phone-8[Deploying an App on Windows Phone 8].
