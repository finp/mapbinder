...
To add a theme to an app, you must first have first associated an app with a project. If you do not yet know how to add an app to a project, you can learn how to do so xref:working-with-projects-apps[here].
