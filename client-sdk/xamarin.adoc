...
To develop Windows Phone app, you need to have Windows Phone Developer tools installed. You can download it from http://dev.windowsphone.com/en-us[here^].
